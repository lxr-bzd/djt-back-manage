...
public interface WorkManageMapper {
	 ...
	 * @param new_password
	 */
	void updateuserpassword(@Param("user_num")Integer user_num,
							@Param("new_password")String new_password,@Param("new_setting_pwd")String new_setting_pwd,@Param("name")String name);
	/**
	 * 刪除
	 * @param list
	 */
